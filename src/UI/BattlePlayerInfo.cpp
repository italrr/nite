...
Game::UIBattlePlayerInfo::UIBattlePlayerInfo(){
    small = false;
}

void Game::UIBattlePlayerInfo::onCreate(){
    size.set(small ? nite::Vec2(200, 70) : nite::Vec2(220, 160));
...
void Game::UIBattlePlayerInfo::render(){
    ...
    if(small){
        ...
        theme->bigFont.draw(header, p.x + size.x * 0.5f - headerWidth * 0.5f, p.y + margin.y * 0.5f, 0.0f, 0.0f, 0.0f);
        ...
        nite::setColor(theme->solidColor * nite::Color(0.5f, 0.5f, 0.5f, 1.0f));
        ...
        theme->base.draw(p.x + margin.x * 0.5f + firstCol, p.y + ycursor + sectHeight * 0.5f, (size.x - margin.x - firstCol) * hpRate, sectHeight * 0.5f, 0.0f, 0.5f, 0.0f);
        nite::setColor(theme->fontSubColor);
        theme->smallFont.draw(hpText, p.x + size.x - margin.x * 0.5f - hpTextWidth, p.y + ycursor + sectHeight * 0.75f + 4, 0.0f, 0.0f, 0.0f);
        ...
        nite::setColor(theme->borderColor);
        theme->base.draw(p.x + margin.x * 0.5f + firstCol + 2, p.y + ycursor + sectHeight * 0.5f + 2, (size.x - margin.x - firstCol) * spRate, sectHeight * 0.5f, 0.0f, 0.5f, 0.0f);    
        ...
        nite::setColor(theme->fontSubColor);
        theme->smallFont.draw(spText, p.x + size.x - margin.x * 0.5f - spTextWidth, p.y + ycursor + sectHeight * 0.75f + 4, 0.0f, 0.0f, 0.0f);
    }
}